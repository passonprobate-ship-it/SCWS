...
- **Hardware**: Control GPIO, I2C, SPI, PWM on the Pi 5 via gpiod/rpi-lgpio
...
- **Hardware**: {{PI_MODEL}} ({{RAM}} RAM), Ubuntu Server 24.04 ARM64
- **Hostname**: {{HOSTNAME}}
...
- **Note**: Old RPi.GPIO and pigpio do NOT work on Pi 5
...
### Control hardware
Use GPIO, I2C, SPI, PWM through gpiod CLI or Python/Node libraries to interact with sensors, LEDs, motors, etc.
...
4. **Be efficient.** The Pi has limited RAM and storage. Don't install unnecessary packages. Keep builds lean.
